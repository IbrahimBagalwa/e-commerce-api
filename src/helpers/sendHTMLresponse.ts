...
<body>
  ...
  <div class="content-wrapper">
    <div class="content">
      ...
      <p>Welcome to the official documentation for the E-COMMERCE API. Discover endpoints, parameters, and responses in a streamlined format.</p>
  ...
  <footer class="footer">
    <p>&copy; 2022 <a href="https://github.com/IbrahimBagalwa">Ibrahim Bagalwa</a>. All rights reserved.</p>
  </footer>
</body>
</html>
`;
